  ...
  return (
    <div className="flex h-12 w-full items-center rounded-md border border-subtle">
      <button
        ...
        className="flex size-12 shrink-0 items-center justify-center text-2xl font-bold text-foreground disabled:cursor-not-allowed disabled:text-foreground-muted"
      >
        –
      </button>
      <input
