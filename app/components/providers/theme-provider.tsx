...
function updateFavicon(bgColor: string, logoColor: string) {
  if (typeof document === 'undefined') return;
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><circle cx="256" cy="256" r="256" fill="${bgColor}"/><path fill="${logoColor}" transform="translate(64 64) scale(0.75)" d="${FAVICON_SVG_PATHS}"/></svg>`;
...
function applyThemeColor(
  ...
  if (typeof document !== 'undefined') {
    ...
    updateFavicon(hex, contrastText);
  }
