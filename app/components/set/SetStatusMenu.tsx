...
export function SetStatusMenu({
  ...
  return (
    ...
    >
      ...
      {open && (
        <div className="absolute -top-4 right-0 z-20 mt-1 w-44 -translate-y-full overflow-hidden rounded-[var(--radius-md)] border-2 border-subtle bg-card text-sm shadow-lg">
