...
export function getStatusContainerClasses(variant: StatusVariant): string {
  switch (variant) {
    case 'success':
      return 'border-brand-green bg-success-muted text-foreground';
    case 'warning':
      return 'border-brand-orange bg-warning-muted text-foreground';
    case 'error':
      return 'border-brand-red bg-danger-muted text-foreground';
    case 'neutral':
      return 'border-neutral-400 bg-card-muted text-foreground';
    case 'info':
    default:
      return 'border-brand-blue bg-info-muted text-foreground';
  }
}
