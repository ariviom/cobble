...
export {
    getGlobalMinifigMapping, getGlobalMinifigMappingsBatch,
    ...
    mapRebrickableFigToBrickLinkOnDemand, mapSetRebrickableFigsToBrickLink,
    mapSetRebrickableFigsToBrickLinkOnDemand,
    // Utility
    normalizeRebrickableFigId, type BatchedMappingOptions,
    // Types
